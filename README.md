...
- I strive to make tools that provive good [UX](https://en.wikipedia.org/wiki/User_experience) and are accessible to everyone (majority and minorities, abled and disabled), but that's sometimes impossible. I typically focus on visual accessibility; but I know there's auditive, motion, and cognitive impairments.
